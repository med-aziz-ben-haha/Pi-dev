...
public class serviceReclamation {
    ...
    public boolean addReclamation(Reclamation t) {
        String url = Statics.BASE_URL + "/addjs/new/"+ t.getDescription_reclamation();
        ...
        try {
            ...
            */
            ...
            for(Map<String,Object> obj : list){
                ...
                t.setId((int)id);
               t.setDescription_reclamation(obj.get("descriptionReclamation").toString());
    ...
    public ArrayList<Reclamation> getAllReclamation(){
     ...
     public boolean  Delete(int id){
       String url = Statics.BASE_URL + "/supprimer/" +id;
