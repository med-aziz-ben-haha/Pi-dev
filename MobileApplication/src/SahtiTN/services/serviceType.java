...
public class serviceType {
    ...
    public boolean addTask(TypeReclamation t) {
   
         String url = Statics.BASE_URL + "/addjson?type_reclamation="+ t.getTypeReclamation();
    ...
    public ArrayList< TypeReclamation> getAllType(){
         String url = Statics.BASE_URL + "/affichertypereclamationjson";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                type = parseTypeReclamation (new String(req.getResponseData()));
    ...
    public ArrayList<TypeReclamation>Tricap(){
        String url = Statics.BASE_URL +"/trimob";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public boolean  Delete(int id){
       String url = Statics.BASE_URL + "/supprimertypereclamationjson/" +id;
