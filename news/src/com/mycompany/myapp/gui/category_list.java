...
import com.mycompany.myapp.services.service_categorie;
        ...
        searchField.addDataChangeListener((i1, i2) -> { 
            ...
            if(t.length() < 1) {
                ...
                for(Component cmp: getContentPane()) {
                    ...
                    String val = ((SpanLabel)  ((Container)((Container) ((Container)((Container) cmp).getComponentAt(2)).getComponentAt(0)).getComponentAt(0)) .getComponentAt(0)).getText();
