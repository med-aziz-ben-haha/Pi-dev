 ...
 * @author LENOVO
 */
public class AfficherSoinMPFrontController implements Initializable {
    ...
    private static String CatSoinId;
    @FXML
    ...
    public String getCatSoinId() {
        return CatSoinId;
    }

    public static void setCatSoinId(String CataideId) {
        AfficherSoinMPFrontController.CatSoinId = CataideId;
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Soins.afficherSoinMPFront(Integer.parseInt(CatSoinId)).forEach((c) -> {
        ...
        for(int i=0; i<data.size();i++){
               ...
               try {
                   ...
                   Logger.getLogger(AfficherSoinMPFrontController.class.getName()).log(Level.SEVERE, null, ex);
               }
