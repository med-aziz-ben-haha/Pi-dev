 ...
 * @author LENOVO
 */
public class HomepageFrontPharController implements Initializable {
    ...
    @FXML
    private Button gestionMedicaments;
    @FXML
...
@FXML
    ...
    @FXML
    private void envoi_Medicament(ActionEvent event) {
         FXMLLoader loader = new FXMLLoader(getClass().getResource("GestionMedicamentBack.fxml"));
        //récupération du root  à partir du fichier fxml
        Parent root;
        ...
        try {
            root = loader.load();
            //récupération du controller lier au fichier fxml 
            GestionMedicamentBackController dpc = loader.getController();
