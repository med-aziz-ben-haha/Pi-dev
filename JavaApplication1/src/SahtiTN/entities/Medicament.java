...
public class Medicament {
    ...
    public String toString() {
        return "Medicament{" + "id=" + id + ", nom_medicament=" + nom_medicament + ", date_modif=" + date_modif + ", dispo=" + dispo + ", img_medicament=" + img_medicament + ", descmedicament=" + descmedicament + ", showimage=" + showimage + '}';
    }
