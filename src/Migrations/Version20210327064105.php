 ...
 */
final class Version20210327064105 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, folder_id INT DEFAULT NULL, type_id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, created DATETIME DEFAULT NULL, deleted DATETIME DEFAULT NULL, file VARCHAR(255) NOT NULL, external TINYINT(1) DEFAULT \'0\', INDEX IDX_6A2CA10C162CB942 (folder_id), INDEX IDX_6A2CA10CC54C8C93 (type_id), INDEX IDX_6A2CA10CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
