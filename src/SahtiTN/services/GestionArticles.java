...
while (result.next()){
   String id = result.getString("id");
    ...
    listarticle.add(article);
       ...
       public void UpdateListArticlesPub(){
         
         String sql = "SELECT * FROM article WHERE type = '1' ";
    ...
    listarticle.add(article);
      ...
      public List<Articles> getArticles() {
        ...
        return listarticle;
           ...
           public List<Articles> getArticlesPub() {
          this.UpdateListArticlesPub();
