...
public class AffichageArticleList implements Initializable{
    ...
    public void SetArticleContenu(String cont){
        this.Articlecontenu.setText(Jsoup.parse(cont).text());
    }
    ...
    */
    public void SetArticleDescription(String description){
        this.Articlevues.setText(description);
    }
    ...
    public void handleClicks(ActionEvent actionEvent) throws MalformedURLException, IOException {
      ...
      System.out.println(source.getId());   
        ...
        if(actionEvent.getSource()==modif)
        {
         ...
         FXMLLoader loader = new FXMLLoader(getClass().getResource("/SahtiTN/gui/ModifierArticle.fxml"));
