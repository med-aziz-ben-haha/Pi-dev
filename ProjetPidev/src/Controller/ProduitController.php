...
class ProduitController extends AbstractController
{
     ...
     */
    public function affiche(SessionInterface $session,ProduitRepository $repository,$id,$iduser,CategorieProduitRepository $categorieProduitRepository){
        ...
        return $this->render('produit/ListProd.html.twig',
            ['produit'=>$produit,'idC'=>$idC,'iduser'=>$iduser,'idpara'=>$idpara,'user'=>$userfind,]);
    }
     ...
     */
    function delete(SessionInterface $session,$id,$iduser,ProduitRepository $repository){
        $user=$session->get('user');
        if(is_null($user))
        {
            return $this->redirectToRoute('connexion');
     ...
     */
    function add(SessionInterface $session,\Symfony\Component\HttpFoundation\Request $request,$id,$iduser,CategorieProduitRepository $repo){
        $user=$session->get('user');
        if(is_null($user))
        {
            return $this->redirectToRoute('connexion');
     ...
     */
    function modifierPara(SessionInterface $session,$id,$iduser,ProduitRepository $repository, \Symfony\Component\HttpFoundation\Request $request){
        $user=$session->get('user');
        if(is_null($user))
        {
            return $this->redirectToRoute('connexion');
     ...
     */
    public function afficheClient( SessionInterface $session,PaginatorInterface $paginator,\Symfony\Component\HttpFoundation\Request $request,CategorieProduitRepository $repository,ParapharmacieRepository $repo,ProduitRepository $repoprod,$idpara,$idcat,$iduser){
        $user=$session->get('user');
        if(is_null($user))
        {
            return $this->redirectToRoute('connexion');
        ...
        return $this->render('produit/AfficheClientCategorieProduit.html.twig',
            ['categorie'=>$categorie , 'idA'=>$idA ,'idC'=>$idC ,'produit'=>$produit ,'parapharmacie'=>$parapharmacie , 'iduser'=>$iduser,'user'=>$userfind,]);
    }
     ...
     */
    public function afficheProduit(SessionInterface $session, \Symfony\Component\HttpFoundation\Request $request,PanierController $panierController,ProduitRepository $repoprod, CategorieProduitRepository $repository,UserRepository $userRepository,PanierRepository $panierRepository,ParapharmacieRepository $repo,$idpara,$idp,$iduser){
        $user=$session->get('user');
        if(is_null($user))
        {
            return $this->redirectToRoute('connexion');
        ...
        if($form->isSubmitted() && $form->isValid()){
            if(is_null($verifPanier)){
                ...
                return $this->redirectToRoute('afficheProduit',array('idp'=>$idp ,'idpara'=>$idpara ,'iduser'=>$iduser,'user'=>$userfind,));
        ...
        return $this->render('produit/AfficheProduit.html.twig',
            [ 'form'=>$form->createView() ,'categorie'=>$categorie,'idpara'=>$idpara , 'idp'=>$idp ,'produit'=>$produit ,'parapharmacie'=>$parapharmacie , 'iduser'=>$iduser,'user'=>$userfind,]);
     ...
     */
    public function afficheBackProduit(SessionInterface $session,ProduitRepository $repository,PaginatorInterface $paginator,\Symfony\Component\HttpFoundation\Request $request){
