...
class ListProduitController extends AbstractController
{
     ...
     */
    public function afficheClient(\Symfony\Component\HttpFoundation\Request $request,PanierRepository $repo,ListProduitRepository $repository,$iduser,$idpanier){
        ...
        return $this->render('list_produit/AfficheClientListProduit.html.twig',
            ['listProduit'=>$listProduit ,'panier'=>$panier ,'iduser'=>$iduser,'idpanier'=>$idpanier ]);
    }

    /**
     * @Route ("/SuppListProd/{id}/{idpanier}/{iduser}",name="deleteListProduit")
     */
    function delete($id,$idpanier,$iduser,PanierController $panierController,PanierRepository $panierRepository,ListProduitRepository $repository){
        ...
        $em->flush();
        return $this->redirectToRoute('afficheClienListProduit',array('idpanier'=>$idpanier ,'iduser'=>$iduser));
    }
     ...
     */
    function modifierPara($id,$iduser,$idprod,$idpanier,PanierController $panierController,ProduitController $produitController,PanierRepository $panierRepository,ProduitRepository $produitRepository,ListProduitRepository $repository, \Symfony\Component\HttpFoundation\Request $request){
        $listProduit=$repository->find($id);
        ...
        return $this->render('list_produit/ModifierListProduit.html.twig',[
            'form'=>$form->createView() , 'iduser'=>$iduser , 'qte'=>$qte
        ]);
     ...
     */
    public function afficheParapharmacien(\Symfony\Component\HttpFoundation\Request $request,ParapharmacieRepository $parapharmacieRepository,PanierRepository $repo,ListProduitRepository $repository,$idpara,$idpanier){
        ...
        return $this->render('list_produit/AfficheParapharmacienListProduit.html.twig',
            ['listProduit'=>$listProduit ,'panier'=>$panier,'idpara'=>$idpara ,'parapharmacie'=>$parapharmacie ,'idpanier'=>$idpanier ]);
    }
     ...
     */
    public function listp(\Symfony\Component\HttpFoundation\Request $request,ParapharmacieRepository $parapharmacieRepository,PanierRepository $repo,ListProduitRepository $repository,$idpara,$idpanier){
