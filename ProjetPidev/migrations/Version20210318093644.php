 ...
 */
final class Version20210318093644 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, parapharmacie_id INT NOT NULL, produit_id INT DEFAULT NULL, prix_tot DOUBLE PRECISION DEFAULT NULL, tva_tot DOUBLE PRECISION DEFAULT NULL, INDEX IDX_24CC0DF2A76ED395 (user_id), INDEX IDX_24CC0DF2D7C4E100 (parapharmacie_id), UNIQUE INDEX UNIQ_24CC0DF2F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
