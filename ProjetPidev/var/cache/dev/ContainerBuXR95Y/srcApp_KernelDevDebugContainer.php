...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.uhhAW0x' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_UhhAW0xService()
    {
        return $this->privates['.service_locator.uhhAW0x'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.uhhAW0x'] ?? $this->get_ServiceLocator_UhhAW0xService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldera42d5 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializercfaa2 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties087b0 = [
        
    ];

    public function getConnection()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getConnection', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getMetadataFactory', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getExpressionBuilder', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'beginTransaction', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->beginTransaction();
    }

    public function getCache()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getCache', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getCache();
    }

    public function transactional($func)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'transactional', array('func' => $func), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->transactional($func);
    }

    public function commit()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'commit', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->commit();
    }

    public function rollback()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'rollback', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getClassMetadata', array('className' => $className), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'createQuery', array('dql' => $dql), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'createNamedQuery', array('name' => $name), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'createQueryBuilder', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'flush', array('entity' => $entity), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'clear', array('entityName' => $entityName), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->clear($entityName);
    }

    public function close()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'close', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->close();
    }

    public function persist($entity)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'persist', array('entity' => $entity), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'remove', array('entity' => $entity), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'refresh', array('entity' => $entity), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'detach', array('entity' => $entity), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'merge', array('entity' => $entity), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getRepository', array('entityName' => $entityName), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'contains', array('entity' => $entity), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getEventManager', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getConfiguration', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'isOpen', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getUnitOfWork', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getProxyFactory', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'initializeObject', array('obj' => $obj), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'getFilters', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'isFiltersStateClean', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'hasFilters', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return $this->valueHoldera42d5->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializercfaa2 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldera42d5) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldera42d5 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldera42d5->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, '__get', ['name' => $name], $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        if (isset(self::$publicProperties087b0[$name])) {
            return $this->valueHoldera42d5->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldera42d5;
    ...
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, '__set', array('name' => $name, 'value' => $value), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;
    ...
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, '__isset', array('name' => $name), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;
    ...
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, '__unset', array('name' => $name), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;
    ...
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, '__clone', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        $this->valueHoldera42d5 = clone $this->valueHoldera42d5;
    }

    public function __sleep()
    {
        $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, '__sleep', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;

        return array('valueHoldera42d5');
    }
    ...
    {
        $this->initializercfaa2 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializercfaa2;
    }

    public function initializeProxy() : bool
    {
        return $this->initializercfaa2 && ($this->initializercfaa2->__invoke($valueHoldera42d5, $this, 'initializeProxy', array(), $this->initializercfaa2) || 1) && $this->valueHoldera42d5 = $valueHoldera42d5;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldera42d5;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldera42d5;
    }
