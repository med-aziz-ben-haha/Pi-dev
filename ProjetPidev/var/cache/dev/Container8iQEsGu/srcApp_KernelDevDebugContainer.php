...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.rGT8UNX' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_RGT8UNXService()
    {
        return $this->privates['.service_locator.rGT8UNX'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Controller\\NoteSoinMPController::ajouterNote' => ['privates', '.service_locator.txaLixa', 'get_ServiceLocator_TxaLixaService', false],
    ...
    /**
     * Gets the private '.service_locator.txaLixa' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_TxaLixaService()
    {
        return $this->privates['.service_locator.txaLixa'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'mailer' => ['privates', 'mailer.mailer', 'getMailer_MailerService', false],
            'session' => ['services', 'session', 'getSessionService', false],
        ], [
            'mailer' => '?',
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.rGT8UNX'] ?? $this->get_ServiceLocator_RGT8UNXService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    {
        return $this->privates['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(['defaultPaginationTemplate' => 'vendor/knplabs/knp-paginator-bundle/templates/Pagination/twitter_bootstrap_v4_pagination.html.twig', 'defaultSortableTemplate' => '@KnpPaginator/Pagination/sortable_link.html.twig', 'defaultFiltrationTemplate' => '@KnpPaginator/Pagination/filtration.html.twig', 'defaultPageRange' => 5, 'defaultPageLimit' => NULL]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'knp_paginator.template.pagination' => 'vendor/knplabs/knp-paginator-bundle/templates/Pagination/twitter_bootstrap_v4_pagination.html.twig',
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder5c5ef = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerab496 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties87cd7 = [
        
    ];

    public function getConnection()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getConnection', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getMetadataFactory', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getExpressionBuilder', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'beginTransaction', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getCache', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getCache();
    }

    public function transactional($func)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'transactional', array('func' => $func), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->transactional($func);
    }

    public function commit()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'commit', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->commit();
    }

    public function rollback()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'rollback', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getClassMetadata', array('className' => $className), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'createQuery', array('dql' => $dql), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'createNamedQuery', array('name' => $name), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'createQueryBuilder', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'flush', array('entity' => $entity), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'clear', array('entityName' => $entityName), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->clear($entityName);
    }

    public function close()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'close', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->close();
    }

    public function persist($entity)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'persist', array('entity' => $entity), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'remove', array('entity' => $entity), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'refresh', array('entity' => $entity), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'detach', array('entity' => $entity), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'merge', array('entity' => $entity), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getRepository', array('entityName' => $entityName), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'contains', array('entity' => $entity), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getEventManager', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getConfiguration', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'isOpen', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getUnitOfWork', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getProxyFactory', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'initializeObject', array('obj' => $obj), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'getFilters', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'isFiltersStateClean', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'hasFilters', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerab496 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder5c5ef) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder5c5ef = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder5c5ef->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, '__get', ['name' => $name], $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        if (isset(self::$publicProperties87cd7[$name])) {
            return $this->valueHolder5c5ef->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c5ef;
    ...
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;
    ...
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, '__isset', array('name' => $name), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;
    ...
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, '__unset', array('name' => $name), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;
    ...
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, '__clone', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        $this->valueHolder5c5ef = clone $this->valueHolder5c5ef;
    }

    public function __sleep()
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, '__sleep', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return array('valueHolder5c5ef');
    }
    ...
    {
        $this->initializerab496 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerab496;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'initializeProxy', array(), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder5c5ef;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5c5ef;
    }
...
class Paginator_f262b94 extends \Knp\Component\Pager\Paginator implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'setDefaultPaginatorOptions', array('options' => $options), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        $this->valueHolder5c5ef->setDefaultPaginatorOptions($options);
return;
    }

    public function paginate($target, int $page = 1, ?int $limit = null, array $options = []) : \Knp\Component\Pager\Pagination\PaginationInterface
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        return $this->valueHolder5c5ef->paginate($target, $page, $limit, $options);
    }

    public function subscribe(\Symfony\Component\EventDispatcher\EventSubscriberInterface $subscriber) : void
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'subscribe', array('subscriber' => $subscriber), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        $this->valueHolder5c5ef->subscribe($subscriber);
return;
    }

    public function connect(string $eventName, $listener, int $priority = 0) : void
    {
        $this->initializerab496 && ($this->initializerab496->__invoke($valueHolder5c5ef, $this, 'connect', array('eventName' => $eventName, 'listener' => $listener, 'priority' => $priority), $this->initializerab496) || 1) && $this->valueHolder5c5ef = $valueHolder5c5ef;

        $this->valueHolder5c5ef->connect($eventName, $listener, $priority);
return;
    }
    ...
    public function __construct(?\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null, ?\Symfony\Component\HttpFoundation\RequestStack $requestStack = null)
    {
        ...
        $this->valueHolder5c5ef->__construct($eventDispatcher, $requestStack);
    }
