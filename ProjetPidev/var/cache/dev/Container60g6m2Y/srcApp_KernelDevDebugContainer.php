...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.T6wQKy9' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_T6wQKy9Service()
    {
        return $this->privates['.service_locator.T6wQKy9'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Controller\\UserController::inscription' => ['privates', '.service_locator.iP8eVIx', 'get_ServiceLocator_IP8eVIxService', false],
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.T6wQKy9'] ?? $this->get_ServiceLocator_T6wQKy9Service())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd339b = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ecb6 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesa210f = [
        
    ];

    public function getConnection()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getConnection', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getMetadataFactory', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getExpressionBuilder', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'beginTransaction', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getCache', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getCache();
    }

    public function transactional($func)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'transactional', array('func' => $func), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->transactional($func);
    }

    public function commit()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'commit', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->commit();
    }

    public function rollback()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'rollback', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getClassMetadata', array('className' => $className), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'createQuery', array('dql' => $dql), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'createNamedQuery', array('name' => $name), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'createQueryBuilder', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'flush', array('entity' => $entity), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'clear', array('entityName' => $entityName), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->clear($entityName);
    }

    public function close()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'close', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->close();
    }

    public function persist($entity)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'persist', array('entity' => $entity), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'remove', array('entity' => $entity), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'refresh', array('entity' => $entity), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'detach', array('entity' => $entity), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'merge', array('entity' => $entity), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'contains', array('entity' => $entity), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getEventManager', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getConfiguration', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'isOpen', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getUnitOfWork', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getProxyFactory', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'initializeObject', array('obj' => $obj), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'getFilters', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'isFiltersStateClean', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'hasFilters', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5ecb6 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd339b) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd339b = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd339b->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, '__get', ['name' => $name], $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        if (isset(self::$publicPropertiesa210f[$name])) {
            return $this->valueHolderd339b->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd339b;
    ...
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;
    ...
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, '__isset', array('name' => $name), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;
    ...
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, '__unset', array('name' => $name), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;
    ...
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, '__clone', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        $this->valueHolderd339b = clone $this->valueHolderd339b;
    }

    public function __sleep()
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, '__sleep', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return array('valueHolderd339b');
    }
    ...
    {
        $this->initializer5ecb6 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer5ecb6;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'initializeProxy', array(), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd339b;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd339b;
    }
...
class Paginator_f262b94 extends \Knp\Component\Pager\Paginator implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'setDefaultPaginatorOptions', array('options' => $options), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        $this->valueHolderd339b->setDefaultPaginatorOptions($options);
return;
    }

    public function paginate($target, int $page = 1, ?int $limit = null, array $options = []) : \Knp\Component\Pager\Pagination\PaginationInterface
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        return $this->valueHolderd339b->paginate($target, $page, $limit, $options);
    }

    public function subscribe(\Symfony\Component\EventDispatcher\EventSubscriberInterface $subscriber) : void
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'subscribe', array('subscriber' => $subscriber), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        $this->valueHolderd339b->subscribe($subscriber);
return;
    }

    public function connect(string $eventName, $listener, int $priority = 0) : void
    {
        $this->initializer5ecb6 && ($this->initializer5ecb6->__invoke($valueHolderd339b, $this, 'connect', array('eventName' => $eventName, 'listener' => $listener, 'priority' => $priority), $this->initializer5ecb6) || 1) && $this->valueHolderd339b = $valueHolderd339b;

        $this->valueHolderd339b->connect($eventName, $listener, $priority);
return;
    }
    ...
    public function __construct(?\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null, ?\Symfony\Component\HttpFoundation\RequestStack $requestStack = null)
    {
        ...
        $this->valueHolderd339b->__construct($eventDispatcher, $requestStack);
    }
