...
return [
    ...
    'listarticle' => [[], ['_controller' => 'App\\Controller\\ArticleController::listarticles'], [], [['text', '/listarticles']], [], []],
    'addarticle' => [[], ['_controller' => 'App\\Controller\\ArticleController::addcarticle'], [], [['text', '/addarticle']], [], []],
    'deletearticle' => [[], ['_controller' => 'App\\Controller\\ArticleController::deletearticle'], [], [['text', '/deletearticle']], [], []],
    'updatearticle' => [[], ['_controller' => 'App\\Controller\\ArticleController::updatearticle'], [], [['text', '/updatearticle']], [], []],
    ...
    'listcategorie' => [[], ['_controller' => 'App\\Controller\\CategorieController::listcategories'], [], [['text', '/listcategories']], [], []],
    'addcategorie' => [[], ['_controller' => 'App\\Controller\\CategorieController::addcategorie'], [], [['text', '/addcategorie']], [], []],
    'deletecategorie' => [[], ['_controller' => 'App\\Controller\\CategorieController::deletecategorie'], [], [['text', '/deletecategorie']], [], []],
    'updatecategorie' => [[], ['_controller' => 'App\\Controller\\CategorieController::updatecategorie'], [], [['text', '/updatecategorie']], [], []],
    ...
    'listmedicamentJSON' => [[], ['_controller' => 'App\\Controller\\MedicamentController::listmedicamentJSON'], [], [['text', '/listmedicamentJSON']], [], []],
    'MedicamentajoutJSON' => [[], ['_controller' => 'App\\Controller\\MedicamentController::MedicamentjoutJSON'], [], [['text', '/MedicamentajoutJSON/new']], [], []],
    '/MedicamentremoveJSON' => [['id'], ['_controller' => 'App\\Controller\\MedicamentController::removeJSON'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/MedicamentremoveJSON']], [], []],
    'MedicamentmodifierJSON' => [['id'], ['_controller' => 'App\\Controller\\MedicamentController::modifierJSON'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/MedicamentmodifierJSON']], [], []],
    'rechercheMedicamentJSON' => [['data'], ['_controller' => 'App\\Controller\\MedicamentController::rechercheMedicamentJSON'], [], [['variable', '/', '[^/]++', 'data'], ['text', '/rechercheMedicamentJSON']], [], []],
    'trimedicamentJSON' => [[], ['_controller' => 'App\\Controller\\MedicamentController::triordonnanceJSON'], [], [['text', '/trimedicamentJSON']], [], []],
    ...
    'listordonnanceJSON' => [[], ['_controller' => 'App\\Controller\\OrdonnanceController::listordonnanceJSON'], [], [['text', '/listordonnanceJSON']], [], []],
    'OrdonnanceajoutJSON' => [[], ['_controller' => 'App\\Controller\\OrdonnanceController::OrdonnanceajoutJSON'], [], [['text', '/OrdonnanceajoutJSON/new']], [], []],
    '/OrdonnanceremoveJSON' => [['id'], ['_controller' => 'App\\Controller\\OrdonnanceController::removeJSON'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/OrdonnanceremoveJSON']], [], []],
    'OrdonnancemodifierJSON' => [['id'], ['_controller' => 'App\\Controller\\OrdonnanceController::modifierJSON'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/OrdonnancemodifierJSON']], [], []],
    'rechercheOrdonnanceJSON' => [['data'], ['_controller' => 'App\\Controller\\OrdonnanceController::rechercheOrdonnanceJSON'], [], [['variable', '/', '[^/]++', 'data'], ['text', '/rechercheOrdonnanceJSON']], [], []],
    'triordonnanceJSON' => [[], ['_controller' => 'App\\Controller\\OrdonnanceController::triordonnanceJSON'], [], [['text', '/triordonnanceJSON']], [], []],
    ...
    'afficher' => [[], ['_controller' => 'App\\Controller\\ReclamationController::AllRec'], [], [['text', '/afficher']], [], []],
    'addjs' => [['description_reclamation'], ['_controller' => 'App\\Controller\\ReclamationController::ajouterJs'], [], [['variable', '/', '[^/]++', 'description_reclamation'], ['text', '/addjs/new']], [], []],
    'supprimer' => [['id'], ['_controller' => 'App\\Controller\\ReclamationController::Supprimer'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/supprimer']], [], []],
    ...
    'affichertypereclamationjson' => [[], ['_controller' => 'App\\Controller\\TypereclamationController::AllType'], [], [['text', '/affichertypereclamationjson']], [], []],
    'trimob' => [[], ['_controller' => 'App\\Controller\\TypereclamationController::trimob'], [], [['text', '/trimob']], [], []],
    'addjson' => [[], ['_controller' => 'App\\Controller\\TypereclamationController::addjson'], [], [['text', '/addjson']], [], []],
    'supprimertypereclamationjson' => [['id'], ['_controller' => 'App\\Controller\\TypereclamationController::Supprimertypereclamationjson'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/supprimertypereclamationjson']], [], []],
