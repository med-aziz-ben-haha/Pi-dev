...
class __TwigTemplate_b7214c40faf5efab5e34a9905ffe256ea4909dc0a889b397c3428fea70e765bd extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        $this->loadTemplate("tempFront1SoinMP.html.twig", "produit/AfficheClientCategorieProduit.html.twig", 1)->display($context);
        // line 2
        echo "
...
<section class=\"services-section hk-section section-bg\" >
    ...
    <div class=\"container\">
        ...
        // line 85
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["produit"]) || array_key_exists("produit", $context) ? $context["produit"] : (function () { throw new RuntimeError('Variable "produit" does not exist.', 85, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
            ...
            echo "
                <div class=\"col-3\">
                    <div class=\"card mb-4 \" style=\"background-color: #d1b1b9\">
                        <a href=\"";
            // line 89
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("afficheProduit", ["idpara" => twig_get_attribute($this->env, $this->source, (isset($context["parapharmacie"]) || array_key_exists("parapharmacie", $context) ? $context["parapharmacie"] : (function () { throw new RuntimeError('Variable "parapharmacie" does not exist.', 89, $this->source); })()), "getId", [], "any", false, false, false, 89), "idp" => twig_get_attribute($this->env, $this->source, $context["p"], "getId", [], "any", false, false, false, 89), "iduser" => (isset($context["iduser"]) || array_key_exists("iduser", $context) ? $context["iduser"] : (function () { throw new RuntimeError('Variable "iduser" does not exist.', 89, $this->source); })())]), "html", null, true);
            echo "\">

                        <img style=\"   width:100%; hight: auto ;\" src=\"";
            // line 91
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . twig_get_attribute($this->env, $this->source, $context["p"], "getLienImgP", [], "any", false, false, false, 91))), "html", null, true);
            echo "\" >
                        <div class=\"card-body\">
            ...
            // line 95
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "nomProduit", [], "any", false, false, false, 95), "html", null, true);
            echo "</h3>

                        <h3 class=\"card-text\">Quantité : ";
            // line 97
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "quantiteProduit", [], "any", false, false, false, 97), "html", null, true);
            echo "</h3>
                        <h3 class=\"text-danger\" style=\"font-weight: bold ; font-size: 2rem\">Prix : ";
            // line 98
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "prixProduit", [], "any", false, false, false, 98), "html", null, true);
            echo " DT</h3>
        ...
        <div class=\"navigation\">
            ";
        // line 110
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["produit"]) || array_key_exists("produit", $context) ? $context["produit"] : (function () { throw new RuntimeError('Variable "produit" does not exist.', 110, $this->source); })()));
        echo "
        </div>
    </div>
</section>
...
";
    ...
    {
        return array (  219 => 115,  211 => 110,  206 => 107,  191 => 98,  187 => 97,  182 => 95,  175 => 91,  170 => 89,  165 => 86,  161 => 85,  123 => 49,  114 => 46,  109 => 44,  106 => 43,  102 => 42,  74 => 17,  66 => 12,  62 => 11,  58 => 10,  54 => 9,  45 => 2,  43 => 1,);
    }
...
{% include 'tempFront2SoinMP.html.twig' %}", "produit/AfficheClientCategorieProduit.html.twig", "C:\\Users\\oussa\\Desktop\\Pi-dev-debutGestionUtil\\ProjetPidev\\templates\\produit\\AfficheClientCategorieProduit.html.twig");
    }
}
