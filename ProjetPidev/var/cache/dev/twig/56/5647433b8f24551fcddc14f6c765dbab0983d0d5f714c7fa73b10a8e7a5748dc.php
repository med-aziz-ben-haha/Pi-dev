...
class __TwigTemplate_3702e943a8dda477376c06ce800aad324a7dec5b286c72f35790cceb406aa728 extends Template
{
    private $source;
    private $macros = [];
...
<section class=\"services-section hk-section section-bg\" >
    <div class=\"container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            ...
            // line 76
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("http://localhost/PIJAVA/uploads/" . twig_get_attribute($this->env, $this->source, $context["i"], "getImgMedicament", [], "method", false, false, false, 76))), "html", null, true);
            echo "\" alt=\"Image\"></td>
                            <td> ";
            // line 77
                ...
                <table id=\"example1\" class=\"table table-bordered table-striped\" >
                    ...
                    {% for i in listmedicament %}
                        <tr>
                            ...
                            <td><img style=\" padding-right: 2px; padding-left: 2px;  width:75px ; height: 75px ; \" src=\"{{ asset ('http://localhost/PIJAVA/uploads/'~ i.getImgMedicament() ) }}\" alt=\"Image\"></td>
...
{% include 'tempFront2MO.html.twig' %}", "medicament/listmedicament.html.twig", "C:\\Users\\LENOVO\\Desktop\\pidev-mobile -integration\\Pi-dev\\ProjetPidev\\templates\\medicament\\listmedicament.html.twig");
    }
}
