...
class __TwigTemplate_a6396449d50d1492346d3787d178fdd4b95ab8d34d6ba7392e41611ea3da6494 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        $this->loadTemplate("tempFront1SoinMP.html.twig", "user/accueilOnlineParapharmacien.html.twig", 1)->display($context);
        // line 2
        echo "
...
<div class=\"row\">
    <div class=\"col-sm-4\">    <a href=\"";
        // line 29
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("afficheCategorieProd", ["id" => (isset($context["idp"]) || array_key_exists("idp", $context) ? $context["idp"] : (function () { throw new RuntimeError('Variable "idp" does not exist.', 29, $this->source); })()), "iduser" => (isset($context["iduser"]) || array_key_exists("iduser", $context) ? $context["iduser"] : (function () { throw new RuntimeError('Variable "iduser" does not exist.', 29, $this->source); })())]), "html", null, true);
...
<div class=\"row\">
    <div class=\"col-sm-4\">    <a href=\"{{ path(\"afficheCategorieProd\",{ 'id': idp , 'iduser' : iduser}) }}\" class=\"btn btn-main-outline mt-2\" style =\"margin-bottom: 20%;margin-top: 8%; width:40%; margin-left:30%;\">Gestion Des Categories<i class=\"fas fa-chevron-right\"></i></a></div>
    <div class=\"col-sm-2\"></div>
    <div class=\"col-sm-4\">    <a href=\"{{ path(\"choixCategorie\",{ 'id': idp , 'iduser' : iduser}) }}\" class=\"btn btn-main-outline mt-2\" style =\"margin-bottom: 20%;margin-top: 8%; width:40%; margin-left:30%;\">Gestion Des Produits<i class=\"fas fa-chevron-right\"></i></a></div>
</div>
