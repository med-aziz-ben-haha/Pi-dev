...
class __TwigTemplate_1bb3670c791d2780ed84cc237740282cb5bddc319a682d52ad2b3ce09a52e50e extends Template
{
    private $source;
    private $macros = [];
...
<p>Objet : ";
        // line 4
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 4, $this->source); })()), "objet", [], "any", false, false, false, 4), "html", null, true);
        echo "</p>
<p>Message : ";
        // line 5
...
", "emails/contact.html.twig", "C:\\Users\\LENOVO\\Desktop\\Pi-dev\\ProjetPidev\\templates\\emails\\contact.html.twig");
    }
}
