...
/* user/inscriptionMed.html.twig */
class __TwigTemplate_463f44dee7ca4b3b98e5a3c0c55151b6a9b2e3f17da23aecb08f0355458e8c26 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "user/inscriptionMed.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "user/inscriptionMed.html.twig"));

        // line 1
        $this->loadTemplate("tempFrontAccueil1.html.twig", "user/inscriptionMed.html.twig", 1)->display($context);
        // line 2
    ...
    ";
        // line 41
        echo "    ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formInscription"]) || array_key_exists("formInscription", $context) ? $context["formInscription"] : (function () { throw new RuntimeError('Variable "formInscription" does not exist.', 41, $this->source); })()), "matriculeFiscale", [], "any", false, false, false, 41), 'label', ["label" => "Matricule Fiscale "]);
        echo "
    ";
        // line 42
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formInscription"]) || array_key_exists("formInscription", $context) ? $context["formInscription"] : (function () { throw new RuntimeError('Variable "formInscription" does not exist.', 42, $this->source); })()), "matriculeFiscale", [], "any", false, false, false, 42), 'widget');
        echo "

    ";
        // line 45
        echo "    ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formInscription"]) || array_key_exists("formInscription", $context) ? $context["formInscription"] : (function () { throw new RuntimeError('Variable "formInscription" does not exist.', 45, $this->source); })()), "specialite", [], "any", false, false, false, 45), 'label', ["label" => "Specialite"]);
        echo "
    ";
        // line 46
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formInscription"]) || array_key_exists("formInscription", $context) ? $context["formInscription"] : (function () { throw new RuntimeError('Variable "formInscription" does not exist.', 46, $this->source); })()), "specialite", [], "any", false, false, false, 46), 'widget');
        echo "

    ";
        // line 48
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formInscription"]) || array_key_exists("formInscription", $context) ? $context["formInscription"] : (function () { throw new RuntimeError('Variable "formInscription" does not exist.', 48, $this->source); })()), 'form_end');
        echo "
</div>
";
        // line 50
        $this->loadTemplate("tempFrontAccueil2.html.twig", "user/inscriptionMed.html.twig", 50)->display($context);
    ...
    {
        return "user/inscriptionMed.html.twig";
    }
    ...
    {
        return array (  161 => 50,  156 => 48,  151 => 46,  146 => 45,  141 => 42,  136 => 41,  131 => 38,  126 => 37,  121 => 34,  116 => 33,  111 => 30,  106 => 29,  101 => 26,  96 => 25,  91 => 22,  86 => 21,  81 => 18,  76 => 17,  71 => 14,  66 => 13,  61 => 10,  56 => 9,  50 => 5,  45 => 2,  43 => 1,);
    }
...
<div style =\"margin-left: 28%; margin-right: 28%;  border: solid 1px #EA3D48; padding:2%; border-radius: 30px; margin-bottom: 25px \">
    ...
    {# { form_errors(formInscription.matriculeFiscale)}#}
    {{ form_label(formInscription.matriculeFiscale,\"Matricule Fiscale \") }}
    {{ form_widget(formInscription.matriculeFiscale)}}

    {# { form_errors(formInscription.specialite)}#}
    {{ form_label(formInscription.specialite,\"Specialite\") }}
    {{ form_widget(formInscription.specialite)}}

    {{ form_end(formInscription) }}
</div>
{% include 'tempFrontAccueil2.html.twig' %}", "user/inscriptionMed.html.twig", "C:\\Users\\oussa\\Desktop\\Pi-dev-debutGestionUtil\\ProjetPidev\\templates\\user\\inscriptionMed.html.twig");
    }
}
