...
class __TwigTemplate_be530e5086851f2aeec634384e52cb19b98b7051f0f672aa2afe30e3bac0196f extends Template
{
    private $source;
    private $macros = [];
...
<p>Email : ";
        // line 2
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 2, $this->source); })()), "email", [], "any", false, false, false, 2), "html", null, true);
        echo "</p>
<p>Objet : ";
        // line 3
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 3, $this->source); })()), "objet", [], "any", false, false, false, 3), "html", null, true);
        echo "</p>
<p>Message : ";
        // line 4
...
<p>Message : {{ contact.message|raw }}</p>", "emails/contact.html.twig", "C:\\Users\\USER\\Pi-dev\\ProjetPidev\\templates\\emails\\contact.html.twig");
    }
}
