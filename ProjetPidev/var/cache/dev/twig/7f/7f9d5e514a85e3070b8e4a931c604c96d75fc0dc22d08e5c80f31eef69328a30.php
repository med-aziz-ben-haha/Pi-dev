...
class __TwigTemplate_8e7bed6c09c043eb9e907c80811245e1877a8629454eee0e0cf1e574decced98 extends Template
{
    private $source;
    private $macros = [];
...
<section class=\"services-section hk-section section-bg\" >
    ...
    <div class=\"container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
            ...
            echo "
                <div class=\"col-3\">
                    <div class=\"card mb-4 service-box\">
                        <a href=\"";
            // line 93
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("afficheProduit", ["idpara" => twig_get_attribute($this->env, $this->source, (isset($context["parapharmacie"]) || array_key_exists("parapharmacie", $context) ? $context["parapharmacie"] : (function () { throw new RuntimeError('Variable "parapharmacie" does not exist.', 93, $this->source); })()), "getId", [], "any", false, false, false, 93), "idp" => twig_get_attribute($this->env, $this->source, $context["p"], "getId", [], "any", false, false, false, 93)]), "html", null, true);
            echo "\">
                        <img style=\"   width:100%; hight: auto ;\" src=\"";
            // line 94
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . twig_get_attribute($this->env, $this->source, $context["p"], "getLienImgP", [], "any", false, false, false, 94))), "html", null, true);
            echo "\" >
                        <div class=\"card-body\">
            ...
            // line 98
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "nomProduit", [], "any", false, false, false, 98), "html", null, true);
            echo "</h3>
            ...
            // line 100
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "quantiteProduit", [], "any", false, false, false, 100), "html", null, true);
            echo "</h3>
                        <h3 class=\"text-danger\" style=\"font-weight: bold ; font-size: 2rem\">Prix : ";
            // line 101
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "prixProduit", [], "any", false, false, false, 101), "html", null, true);
            echo " DT</h3>
...
";
    ...
    {
        return array (  219 => 115,  212 => 110,  197 => 101,  193 => 100,  189 => 99,  185 => 98,  178 => 94,  174 => 93,  169 => 90,  165 => 89,  127 => 53,  118 => 50,  113 => 48,  110 => 47,  106 => 46,  78 => 21,  70 => 16,  66 => 15,  62 => 14,  58 => 13,  45 => 2,  43 => 1,);
    }
