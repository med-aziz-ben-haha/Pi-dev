...
class __TwigTemplate_d5c8e29fee8b75de7b6444de480a09973b1d7a98bdf5474db25bd6d5cadfd279 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
            ...
            echo "\" class=\"btn btn-main-outline mt-2\">Gestion Categorie<i class=\"fas fa-chevron-right\"></i></a>
                        <a href=\"";
            // line 18
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("afficheProd", ["id" => twig_get_attribute($this->env, $this->source, $context["p"], "getId", [], "method", false, false, false, 18)]), "html", null, true);
            ...
            {% for p in parapharmacie %}
                <div class=\"col-12 col-md-6 col-lg-4\">
                    <div class=\"service-box text-center\">
                        ...
                        <a href=\"{{ path(\"afficheProd\",{'id':p.getId() } ) }}\" class=\"btn btn-main-outline mt-2\">Visiter<i class=\"fas fa-chevron-right\"></i></a>
...
{% include 'tempFront2SoinMP.html.twig' %}", "parapharmacie/FrontListPara.html.twig", "C:\\Users\\oussa\\Desktop\\Pi-dev\\ProjetPidev\\templates\\parapharmacie\\FrontListPara.html.twig");
    }
}
