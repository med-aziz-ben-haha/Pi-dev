...
class __TwigTemplate_be2325f227dae1d139160508de2e40164233c5b46f8f97fae85ce651cece1f6a extends Template
{
    private $source;
    private $macros = [];
...
<header class=\"hk-header\">
    <nav class=\"navbar navbar-expand-lg fixed-top navbar-light hk-navbar\">
        ...
        // line 80
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("/gestionprofil/" . (isset($context["iduser"]) || array_key_exists("iduser", $context) ? $context["iduser"] : (function () { throw new RuntimeError('Variable "iduser" does not exist.', 80, $this->source); })()))), "html", null, true);
        echo "\">Profile</a>
            ...
            <div class=\"navbar-collapse hk-offcanvas\" id=\"navbarsExampleDefault\">
                ...
                <ul class=\"navbar-nav ml-auto\">
                    <li class=\"nav-item dropdown\">
                        <a class=\"nav-link dropdown-toggle\" href=\"https://example.com\" id=\"dropdown01\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\"><i class=\"far fa-user\"></i> My Account</a>
                        <div class=\"dropdown-menu\" aria-labelledby=\"dropdown01\">
                            <a class=\"dropdown-item\" href=\"{{ asset('/gestionprofil/' ~ iduser) }}\">Profile</a>
                            <a class=\"dropdown-item\" href=\"#\">Edit Account</a>
