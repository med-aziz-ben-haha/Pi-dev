...
class __TwigTemplate_dfc02ab49e0df4c59e76c2c83c8f526b69f07213cf4908c8048fea763e8a04f2 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        $this->loadTemplate("tempClient.html.twig", "categorie_produit/AfficheClientCategorie.html.twig", 1)->display($context);
        // line 2
        echo "
...
<section class=\"services-section hk-section section-bg\" >
    ...
    <div class=\"container\">
        ...
        // line 88
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["produit"]) || array_key_exists("produit", $context) ? $context["produit"] : (function () { throw new RuntimeError('Variable "produit" does not exist.', 88, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
            ...
            echo "
                <div class=\"col-3 \">
                    <div class=\"card mb-4 \" style=\"background-color: #d1b1b9\">
                        ...
                        <a href=\"";
            // line 93
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("afficheProduit", ["idpara" => twig_get_attribute($this->env, $this->source, (isset($context["parapharmacie"]) || array_key_exists("parapharmacie", $context) ? $context["parapharmacie"] : (function () { throw new RuntimeError('Variable "parapharmacie" does not exist.', 93, $this->source); })()), "getId", [], "any", false, false, false, 93), "idp" => twig_get_attribute($this->env, $this->source, $context["p"], "getId", [], "any", false, false, false, 93), "iduser" => (isset($context["iduser"]) || array_key_exists("iduser", $context) ? $context["iduser"] : (function () { throw new RuntimeError('Variable "iduser" does not exist.', 93, $this->source); })())]), "html", null, true);
            echo "\">

                        <img style=\"   width:100%; hight: auto ;\" src=\"";
            // line 95
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . twig_get_attribute($this->env, $this->source, $context["p"], "getLienImgP", [], "any", false, false, false, 95))), "html", null, true);
            echo "\" >
                        <div class=\"card-body\">
            ...
            // line 99
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "nomProduit", [], "any", false, false, false, 99), "html", null, true);
            echo "</h3>

                            <h3 class=\"card-text\">Quantité : ";
            // line 101
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "quantiteProduit", [], "any", false, false, false, 101), "html", null, true);
            echo "</h3>
                            <h3 class=\"text-danger\" style=\"font-weight: bold ; font-size: 2rem\">Prix : ";
            // line 102
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "prixProduit", [], "any", false, false, false, 102), "html", null, true);
            echo " DT</h3>
        ...
        <div class=\"navigation\">
            ";
        // line 116
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["produit"]) || array_key_exists("produit", $context) ? $context["produit"] : (function () { throw new RuntimeError('Variable "produit" does not exist.', 116, $this->source); })()));
        echo "
        </div>
    </div>
</section>
...
";
        // line 125
        $this->loadTemplate("tempFront2SoinMP.html.twig", "categorie_produit/AfficheClientCategorie.html.twig", 125)->display($context);
    ...
    {
        return array (  229 => 125,  217 => 116,  211 => 112,  195 => 102,  191 => 101,  186 => 99,  179 => 95,  174 => 93,  168 => 89,  164 => 88,  123 => 49,  114 => 46,  109 => 44,  106 => 43,  102 => 42,  74 => 17,  66 => 12,  62 => 11,  58 => 10,  54 => 9,  45 => 2,  43 => 1,);
    }
...
{% include 'tempFront2SoinMP.html.twig' %}", "categorie_produit/AfficheClientCategorie.html.twig", "C:\\Users\\LENOVO\\Desktop\\Pi-dev\\ProjetPidev\\templates\\categorie_produit\\AfficheClientCategorie.html.twig");
    }
}
