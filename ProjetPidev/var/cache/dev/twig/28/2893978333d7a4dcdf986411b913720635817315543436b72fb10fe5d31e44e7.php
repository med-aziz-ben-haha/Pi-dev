...
class __TwigTemplate_c7addb5310148fbebd66df5c232d7a3bd04af854379abe0798b6dd787a21ca45 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav class=\"navbar navbar-expand-lg fixed-top navbar-light hk-navbar\">
        ...
        echo "\">Médecine Parallèle</a>
                    ...
                    <li class=\"nav-item\">
                        <a class=\"nav-link\" href=\"";
        // line 73
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("afficheFrontClientPara", ["iduser" => (isset($context["iduser"]) || array_key_exists("iduser", $context) ? $context["iduser"] : (function () { throw new RuntimeError('Variable "iduser" does not exist.', 73, $this->source); })())]), "html", null, true);
        echo "\">Parapharmacie</a>
                    ...
                    <li class=\"nav-item\">
                        <a class=\"nav-link\" href=\"";
        // line 84
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("afficheClienPanier", ["iduser" => (isset($context["iduser"]) || array_key_exists("iduser", $context) ? $context["iduser"] : (function () { throw new RuntimeError('Variable "iduser" does not exist.', 84, $this->source); })())]), "html", null, true);
...
";
    ...
    {
        return array (  190 => 125,  158 => 96,  143 => 84,  129 => 73,  121 => 68,  104 => 54,  76 => 29,  72 => 28,  43 => 1,);
    }
